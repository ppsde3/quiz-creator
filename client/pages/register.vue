        ...
        <div class="flex flex-wrap px-5 pt-5 pb-2 font-medium text-base">
            <div class="p-2 w-full sm:w-1/2">
                ...
                <FormInputField
                    ...
                    input-id="email"
                    :input-value="registerFormData.email"
            ...
            <div class="p-2 w-full sm:w-1/2">
                ...
                <FormInputField
                    ...
                    v-on:inputChange="handleInputChange"
                    input-id="name"
                    :input-value="registerFormData.name"
            ...
            <div class="p-2 w-full sm:w-1/2">
                ...
                <FormInputField
                    ...
                    v-on:inputChange="handleInputChange"
                    input-id="password"
                    :input-value="registerFormData.password"
                    input-placeholder="Password (atleast 6 characters)"
                />
            </div>
            <div class="p-2 w-full sm:w-1/2">
                ...
                <FormInputField
                    ...
                    :input-value="registerFormData.confirmPassword"
